...
BIN_DIR=$(dirname $0)
PROJECT_ROOT=$(python3 -c "import os; print(os.path.realpath('$BIN_DIR'+'./../'))")
...
alembic -c migrations/alembic.ini -x dburl=postgresql+psycopg2://${USER}:${PASSWORD}@${DB_HOST}:${PORT}/${DB_NAME} upgrade head